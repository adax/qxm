  ...
  members :
  {
    ...
    main : function()
    {
      ...
      */
      ...
      // Create a button
      var changePassword = new qxm.ui.form.authentication.ChangePassword();
      changePassword.addListener("passwordChanged", function(ev) {
         var loginData = ev.getData();
         alert(loginData.username + "     " + loginData.password);
      });

      var renderer = new qx.ui.form.renderer.Single(changePassword);

      // Document is the application root
      var doc = this.getRoot();

      // Add button to document at fixed coordinates
      doc.add(renderer, {left: 10, top: 10});
    }
  }
});
